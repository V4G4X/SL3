...
<body>
	<nav class="navbar navbar-expand-sm bg-dark navbar-dark fixed-top">
		...
		<form class="form-inline" style="padding-left: 35%;">
		    ...
		    <a href="Index.jsp" style="padding-left: 1%"><button type="button" class="btn btn-primary">Log Out</button></a>
	</nav>
...
And this world has room for everyone, and the good Earth is 
rich can provide for everyone.
The way of life can be free and beautiful, but we have lost the way.
Greed has posioned men's souls, has barricaded the world with hate, 
...
and little children - victims of a system that makes men torture 
...
Soldiers!
In the name of democracy, let us all unite</p>
		</pre>
		<footer class="blockquote-footer">Charlie Chaplin</footer>
		</blockquote>
		</div>
